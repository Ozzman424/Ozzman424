...
class TinderBot():
    ...
    def open_tinder(self):
        ...
        sleep(6)
        try:
            allow_location_button = self.driver.find_element('xpath', '/html/body/div[2]/div/div[1]/div/div/div[3]/button[1]')
            allow_location_button.click()
        except:
            print('no location popup')

        try:
            notifications_button = self.driver.find_element('xpath', '/html/body/div[2]/div/div[1]/div/div/div[3]/button[2]')
